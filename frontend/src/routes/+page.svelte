            ...
            <span
              ...
              var(--color-indigo-400); padding: 0 8px; margin-left: 10px;" class="text-[16px]">demo</span
				...
				<div class="flex items-center">
					<a
						href="/dependencies"
						class="mr-[15px] rounded-md bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition duration-200 hover:bg-indigo-700"
						>Dependencies
					</a>
			...
			{:else}
				<div class="flex">
					<div class="rows-auto grid w-[100%] grid-cols-4 gap-5">
						...
						<a
							href="/create"
							class="mx-auto flex w-full max-w-sm items-center justify-center rounded-lg bg-[#272727] p-4 shadow-md"
						>
							<div>
								<h2 class="rounded-lg text-[96px]">+</h2>
							</div>
						</a>
					</div>
				</div>
